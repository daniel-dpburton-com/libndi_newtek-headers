...
install: all
	...
	$(INSTALL) -m 0644 lib/Processing.NDI.Lib.UWP.x86.lib '$(DESTDIR)$(PREFIX)/lib/'
	$(INSTALL) -m 0644 lib/Processing.NDI.Lib.x86.lib '$(DESTDIR)$(PREFIX)/lib/'
	$(INSTALL) -m 0755 -d '$(DESTDIR)$(PREFIX)/bin-video'
	$(INSTALL) -m 0644 lib/Processing.NDI.Lib.UWP.x86.lib '$(DESTDIR)$(PREFIX)/bin-video/'
	$(INSTALL) -m 0644 lib/Processing.NDI.Lib.x86.lib '$(DESTDIR)$(PREFIX)/bin-video/'
...
uninstall:
	...
	rm -f '$(DESTDIR)$(PREFIX)/lib/Processing.NDI.Lib.UWP.x86.lib'
	rm -f '$(DESTDIR)$(PREFIX)/lib/Processing.NDI.Lib.x86.lib'
